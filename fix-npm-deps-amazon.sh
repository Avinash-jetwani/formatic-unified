...
# Create a customized deployment script
log "Creating fixed deployment script..."
...
# Build and deploy backend with fixed dependencies
deploy_backend() {
  log "Deploying backend..."
  cd "\$BACKEND_DIR"
  
  log "Installing backend dependencies with --legacy-peer-deps..."
...
# Build and deploy frontend with fixed dependencies
deploy_frontend() {
...
# Main function
main() {
  log "Starting deployment with dependency fixes..."
...
log "Running fixed deployment script..."
./deploy_fixed.sh 